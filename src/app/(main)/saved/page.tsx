    ...
    return (
      <div className="min-h-screen bg-background pt-16 md:pt-20 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">Create an account to save and compare properties</p>
  ...
  return (
    <div className="min-h-screen bg-background pt-16 md:pt-20">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <p className="text-muted-foreground mb-8">{favorites.length} properties saved</p>

        {favorites.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-sm">
            <Heart className="w-12 h-12 text-muted-foreground mx-auto mb-4" />
            <h2 className="text-xl font-semibold mb-2">No saved properties yet</h2>
            <p className="text-muted-foreground mb-4">Browse properties and click the heart icon to save them</p>
